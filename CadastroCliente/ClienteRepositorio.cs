        ...
        public List<Cliente> ListarClientes()
        {
            ...
            using (var conn = database.GetConnection())
            {
                ...
                while (reader.Read())
                {
                    ...
                    var nomeSocial = !reader.IsDBNull(reader.GetOrdinal("nome_social")) ? reader.GetString("nome_social") : "";
                    var complemento = !reader.IsDBNull(reader.GetOrdinal("complemento")) ? reader.GetString("complemento") : "";
